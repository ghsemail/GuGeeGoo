...
```bash
# 生成练习 PDF
npm run pdf -- 资料-materials/英语-english/五年级-grade5/练习-exercises/第N单元-unitN/源文件-source/<文件名>.md

# 同时生成答案 PDF
npm run pdf -- 资料-materials/英语-english/五年级-grade5/练习-exercises/第N单元-unitN/源文件-source/<文件名>.md --answers <答案文件名>.md
```
